...
This repo treats dependency, workflow, extension, skill, and submodule changes as security-sensitive.

## Required defaults

- Use committed lockfiles for installs; do not silently refresh lockfiles inside unrelated changes.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, extension source, skills, and submodule refs.
